...
public class CustomReporter extends CustomReporterListener {
    ...
    protected PrintWriter createWriter(String outdir) throws IOException { // 2.1
        ...
        return new PrintWriter(new BufferedWriter(new FileWriter(new File(outdir, "emailable-report-new" + ".html"))));
    }
    ...
    private void startResultSummaryTable(String style) { // 5.2.1
        ...
        m_out.println("<tr><td colspan='4'>Overall test suite completion : <b>" + Time
                ...
                + BrowserCaps.browserName + "<t></t>" + BrowserCaps.browserVersion + "</b><br/>OS: <b>"
     ...
     * @return Return the Method result
     */
     ...
     *
     * @param out PrintWriter Stream instance
     */
    protected void endHtml(PrintWriter out) {
        // out.println("<center> Report customized by KiwiQA
        // </center><br/><br/>");
        out.println(
                "<tr bgcolor='SkyBlue'><td align='right' colspan='4'><center><b><i>Report customized by KiwiQA </i><b><center></center></b></b></center></td></tr>");
